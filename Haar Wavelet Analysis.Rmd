...
z=ncol(Differences)
j=c(1:(z))
#fDiffScaled=function(Differences){
  #Differences[z,i]*(4/(2^j))}
#DiffScaled=fDiffScaled(Differences)
#DiffScaled
DiffScaled<- as.matrix(Differences)
heatmap(DiffScaled, col = cm.colors(256), scale= "column", Rowv = NA, Colv = NA, labCol= "Frequency" )
```
